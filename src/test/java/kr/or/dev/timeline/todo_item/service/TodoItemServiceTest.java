package kr.or.dev.timeline.todo_item.service;
...
public class TodoItemServiceTest {
	...
	/**
	* Method : todoItemServiceTest
	* 최초작성일 : 2018. 9. 21.
	* 작성자 : 김지수
	* 변경이력 :
	* Method 설명 : todoItemService TEST
	*/
	@Test
	public void todoItemServiceTest() {
	...
	*/
	...
	public void inserTiTest(){
		...
		/***When***/
		int insertCnt = todoItemService.insertTi(tiVo);
	...
	*/
	...
	public void deleteTiRTest(){
		...
		/***When***/
		int deleteCnt = todoItemService.deleteTiR(ti_no);
	...
	*/
	...
	public void getTiListTest(){
		...
		/***When***/
		List<TodoItemVO> tiList = todoItemService.getTiList(todo_no);
