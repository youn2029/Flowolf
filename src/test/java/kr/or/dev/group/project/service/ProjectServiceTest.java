...
public class ProjectServiceTest {
	...
	* 작성자 : 윤성호
	* 변경이력 :
	* Method 설명 : proService 테스트
	*/
	@Test
	public void proServiceTest(){
		assertNotNull(proService);
	}
	...
	*/
	...
	public void updateProTest(){
		...
		/***When***/
		int updateCnt = proService.updatePro(proVo);
	...
	*/
	...
	public void deleteProTest(){
		...
		/***When***/
		int deleteCnt = proService.deletePro(10000);
	...
	*/
	...
	/**
	* Method : getProPageAllListTest
	* 최초작성일 : 2018. 9. 4.
	* 작성자 : 윤성호
	* 변경이력 :
	* Method 설명 : 전체 프로젝트 페이지네이션 조회 Test
	*/
	@Test
	public void getProPageAllListTest(){
		/***Given***/		
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put("page", 1);
		...
		/***When***/
		List<ProjectVO> allProList = proService.getProPageAllList(paramMap);
	...
	*/
	...
	public void getProKindCntTest(){
		...
		/***When***/
		int kindProCnt = proService.getProKindCnt(10000);
	...
	*/
	...
	public void getProSearchListTest(){
		...
		/***When***/
		List<ProjectVO> proSearchList = proService.getProSearchList(searchMap);
	...
	*/
	...
	public void getProAllListTest(){
		...
		/***When***/
		List<ProjectVO> allProList = proService.getProAllList();
