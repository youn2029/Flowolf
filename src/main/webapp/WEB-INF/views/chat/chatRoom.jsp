					...
					success : function(response) {
						if (fileExt == "jpg" || fileExt == "png"
							...
							wsocket.send("msg-i:"
											...
											+ nickname
											+ ","
											+ "<a href=/chat/fileDownload?chat_file_no="
						...
						<c:choose>
							<c:when
								...
								<div class="textMsgBoxWrap">
									<p class="date left">
										<fmt:formatDate value="${list.time }" pattern="MM/dd a hh:mm" />
									</p>
										...
										<div class="myTextBox ">
											...
											<c:if test="${list.chatConVo == null}">
												<c:if
													...
													<span><a
														href="/chat/fileDownload?chat_file_no=${list.chatFileVo.chat_file_no }"><img
												...
												<c:if
													test="${list.chatFileVo.type != 'jpg' && 
														  ...
														  list.chatFileVo.type != 'bmp'}">
													<span><a
														href="/chat/fileDownload?chat_file_no=${list.chatFileVo.chat_file_no }"><i
							...
							<c:when
								...
								<div class="textMsgBoxWrap left">
									<div class="frofile-img">
										...
										<c:if test="${list.chatConVo == null }">
											<img src="/mem/pic?mem_id=${list.chatFileVo.mem_id }" />
										</c:if>
									</div>
									<div class="left">
										<c:if test="${list.chatFileVo == null }">
										...
										<c:if test="${list.chatConVo == null }">
											<p class="nick">${list.chatFileVo.mem_nick }</p>
										</c:if>
										<p class="date right">
											<fmt:formatDate value="${list.time }" pattern="MM/dd a hh:mm" />
										</p>
