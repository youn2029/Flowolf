...
<!-- 		<form action="/post/update" method="post" class="posi-re"> -->
		<form action="/adm/update" method="post" enctype="multipart/form-data" class="posi-re">

			<input type="hidden" name="post_no" value="${postVo.post_no }">
		
			<!-- secret post check -->
			<input type="hidden" id="postPwChk" name="post_pw_chk" value="n">
			<input type="password" id="postPassword" name="post_pw" value="" placeholder="4자리 숫자로만 입력해주세요" class="marleft-20" style="display:none">
