	...
	<div class="post-detail-wrap float-left">
		...
		<div class="post-header">
			<div class="post-nav float-left marbtm-20">
				<a href="/pro/main" class="color-gray">HOME</a>
				<a href="/post/list?post_kind=${postVo.post_kind }" class="color-gray">
					<c:choose>
		...
		<div class="post-detail-content">
			...
			<div class="post-btn-box">
				<a href="/post/list?post_kind=${postVo.post_kind }">목록</a>
			
				<ul class="float-right marbtm-0">
					<c:if test="${postVo.mem_id == memVo.mem_id }">
					<li><a href="/post/updateView?post_no=${postVo.post_no }">수정</a></li>
					<li><a class="post-delete-btn" data-no="${postVo.post_no }">삭제</a></li>
					<li><a href="/post/insertView" class="color-white back-color-pupple-l">글쓰기</a></li>
					</c:if>
				</ul>
			</div>
	...
	<div class="post-footer">
		...
		<div class="post-comment-box">
			...
			<div class="post-comment-list">
				...
				<div class="post-comment-con">
					...
					<div class="dis-inblock comment-user-info">
						...
						<c:if test="${postRep.mem_id == memVo.mem_id }">
			...
			$(".post-delete-btn").click(function(){
				...
				$("#deleteTimeLine .timeline_col").val("post_no");
