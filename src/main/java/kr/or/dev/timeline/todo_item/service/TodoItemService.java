...
public class TodoItemService implements TodoItemServiceInf {
	...
	*/
	...
	public int insertTi(TodoItemVO tiVo) {
		return todoItemDao.insertTi(tiVo);
	}
	...
	*/
	...
	public int updateTi(TodoItemVO tiVo) {
		return todoItemDao.updateTi(tiVo);
	}
	...
	*/
	...
	public int deleteTiR(int ti_no) {
		return todoItemDao.deleteTiR(ti_no);
	}
	...
	*/
	...
	public List<TodoItemVO> getTiList(int todo_no) {
		return todoItemDao.getTiList(todo_no);
	}
