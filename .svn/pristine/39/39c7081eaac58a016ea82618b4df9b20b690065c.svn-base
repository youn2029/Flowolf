...
public class BoxProjectDaoTest {
	...
	* 작성자 : 윤성호
	* 변경이력 :
	* Method 설명 : boxProDao Test
	*/
	@Test
	public void boxProDaoTest() {
		assertNotNull(boxProDao);
	}
	...
	*/
	...
	public void insertBoxPro(){
		...
		/***When***/
		int resultCnt = boxProDao.insertBoxPro(boxProVo);
	...
	*/
	...
	public void deleteBoxProRTest(){
		...
		/***When***/
		int resultCnt = boxProDao.deleteBoxProR(boxProVo);
	...
	*/
	...
	public void getBoxProListTest(){
		...
		/***When***/
		List<ProjectVO> boxProList = boxProDao.getBoxProList(paramMap);
