...
<nav class="navbar-con">
	...
	<div class="swiper-container asdie-scroll">
		...
		<div class="swiper-wrapper">
			<div class="swiper-slide">
				...
				<ul class="nav-list collection-nav">
					<li><a href="/task/taskAll?mem_id=${memVo.mem_id }"><i class="fas fa-laptop color-green-l"></i><span>전체 업무</span></a></li>
					<li><a href="/schd/callCalendar"><i class="far fa-calendar-alt color-red"></i><span>전체 일정</span></a></li>
					<li><a href="/files/fileBox?mem_id=${memVo.mem_id }"><i class="fas fa-download color-blue-l"></i><span>전체 파일</span></a></li>
					<li><a href="/coll/collArticle"><i class="far fa-bookmark color-pupple"></i><span>담아둔 글</span></a></li>
<!-- 					<li><a href=""><i class="fas fa-at color-red"></i><span>나를 지정</span></a></li> -->
					<li><a href="/coll/myArticle"><i class="fas fa-user-edit color-gray"></i><span>내 게시물</span></a></li>
				</ul>
