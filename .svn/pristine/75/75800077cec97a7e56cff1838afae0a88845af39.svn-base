...
public class TaskServiceTest {
	...
	*/
	...
	public void getTaskSeqTest(){
		...
		/***When***/
		int resuntCnt = taskService.getTaskSeq();
	...
	*/
	...
	public void insertTaskTest(){
		...
		taskVo.setTask_no(taskService.getTaskSeq());
	...
	*/
	...
	public void getTaskMyListTest(){
		...
		/***When***/
		List<TimeLine> taskMyList = taskService.getTaskMyList(mem_id);
	...
	*/
	...
	public void getTaskCollListTest(){
		...
		/***When***/
		List<TimeLine> taskCollList = taskService.getTaskCollList("test");
