...
public class FilesServiceTest {
	...
	*/
	...
	public void getFilesRepAllListTest(){
		...
		/***When***/
		List<FilesVO> repFilesList = filesService.getFilesRepAllList(paramMap);
	...
	*/
	...
	public void getProFilesBaTaAllListTest(){
		...
		/***When***/
		List<FilesVO> proBasicFilesList = filesService.getProFilesBaTaAllList(paramMap);
	...
	*/
	...
	public void getProFilesRepAllListTest(){
		...
		/***When***/
		List<FilesVO> proRepFilesList = filesService.getProFilesRepAllList(paramMap);
