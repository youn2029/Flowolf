...
public class VoteItemUserDaoTest {
	...
	* 작성자 : 윤성호
	* 변경이력 :
	* Method 설명 : viuDaoTest
	*/
	@Test
	public void viuDaoTest() {
		assertNotNull(viuDao);
	}
	...
	*/
	...
	public void insertViuTest(){
		...
		/***When***/
		int resultCnt = viuDao.insertViu(viuVo);
	...
	*/
	...
	public void deleteViuTest(){
		...
		/***When***/
		int resultCnt = viuDao.deleteViu(viuVo);
	...
	*/
	...
	public void getViuListTest(){
		...
		/***When***/
		List<VoteItemUserVO> viuList = viuDao.getViuList(10000);
