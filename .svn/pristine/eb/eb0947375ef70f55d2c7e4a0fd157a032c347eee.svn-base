...
<section class="col-md-10 admin-con-wrap">
	...
	<!-- title -->
	<div class="dis-block marbtm-20">
		<strong class="dis-inblock size-30 color-black">환경설정</strong>
		<span class="dis-inblock marleft-15 size-18 color-gray">Admin Preferences</span>
	</div>
