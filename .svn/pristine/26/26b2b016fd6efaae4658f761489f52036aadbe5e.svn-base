...
<section class="col-md-10 admin-con-wrap">
	...
	<div class="admin-content mem-edit-box martop-20">
		<form action="/adm/memUpdate" method="post" enctype="multipart/form-data">
			<dl>
				<dt class="posi-re">
				...
				<dd>
					<table class="table">
						...
						<tr>
							<td>비밀번호</td>
							<td>
								<input type="password" id="mem_pass" name="mem_pass" class="mem_pass" value="12345678">
								<input type="hidden" id="mem_pw" name="mem_pw" class="mem_pw" value="" readonly>
							</td>
						</tr>
						<tr>
							<td>이름</td>
							<td>
								<input type="text" id="mem_name" name="mem_name" readonly>
							</td>
						</tr>
						<tr>
							<td>닉네임</td>
							<td>
								<input type="text" id="mem_nick" name="mem_nick" readonly>
							</td>
						</tr>
					</table>
	...
	<div class="admin-content mem-list-box martop-20">
			...
			<tbody> 
				...
				<tr onclick="fn_memberInfoInput(this)">
					...
					<td class="mem_chk">
						...
						<input type="hidden" id="mem_pic" class="mem_pic"  value="${list.mem_phone }">
					</td>
				</tr>
				</c:forEach>
			</tbody>
		...
		<!-- admin_memList pagination : s -->
		<div class="text-center">
			<ul class="pagination">
 				${pageNavi }
			</ul>
		</div>
		<!-- admin_memList pagination : f -->
